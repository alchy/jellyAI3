...
| 12 | Topos | Hierarchie míst (Praha ⊂ Čechy), containment, „tady/poblíž". | ZAPARKOVÁNO (pokyn 2026-07-18) — pilovat stávající; návrhy hotové (spec subsystémy §5 + topos-geo). | park |
