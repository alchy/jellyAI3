...
| 27 | Chronos | **Správa plánu dialogem** (zadání 2026-07-18): „přeplánuj vyzvednutí ze 17 na 20", „zruš všechno na zítra", „posuň všechny ze zítra na čtvrtek" — operace nad skladem připomínek (výběr cílů intervalem/textem, hromadný posun, zrušení; jména dnů v týdnu jako cíl termínu). | Karty reminder-cancel/move + mechanismus výběru záznamů (interval z „ze zítra", posun na den v týdnu — weekday_names už v lang); potvrzení kartou. Výpis plánu (reminder-list) HOTOV. | **2** |
